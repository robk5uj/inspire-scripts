...
from job_helper import all_recids

from invenio.search_engine import get_record, search_unit
from invenio.textutils import encode_for_xml
from invenio.dbquery import run_sql
from invenio.bibupload import update_database_with_metadata
...
def main():
    deleted_records = search_unit(p='DELETED', f='980', m='a')
    with open("recids_to_correct", "w") as out:
        for recid in all_recids():
            if recid in deleted_records:
                continue
            try:
